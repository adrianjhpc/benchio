...
#define MAX_CONT_NAME_LEN 255
char container_name[MAX_CONT_NAME_LEN] = "";
...
void daos_read_object_fortran(int num_dims, long int *objectsize, long int *objectgsize, long int *objectsubsize, long int *objectstart, double *output_data, char *obj_class, int repeats, int daosconfig, MPI_Fint communicator);
