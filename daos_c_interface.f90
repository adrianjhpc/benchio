module daos_c_interface
  ...
  interface
     ...
     subroutine daos_write(arraysize, arraygsize, arraysubsize, arraystart, data, obj_class, block_size, communicator) bind(c, name="daos_write_array_fortran")
       import :: c_char
       import :: c_int
       import :: c_size_t
       import :: c_double
     ...
     subroutine daos_read(arraysize, arraygsize, arraysubsize, arraystart, output_data, obj_class, communicator) bind(c, name="daos_read_array_fortran")
       import :: c_char
       import :: c_int
       import :: c_size_t
       import :: c_double
