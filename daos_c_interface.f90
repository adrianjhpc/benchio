module daos_c_interface
  ...
  interface
     ...
     subroutine daos_write_array(num_dims, arraysize, arraygsize, arraysubsize, arraystart, data, obj_class, block_size, repeats, keep_data, daosconfig, communicator) bind(c, name="daos_write_array_fortran")
       import :: c_char
       import :: c_int
       import :: c_size_t
       import :: c_double
       ...
       integer(kind=c_int), value, intent(in) :: num_dims, repeats, keep_data, daosconfig, communicator
     end subroutine daos_write_array

     subroutine daos_write_object(num_dims, objectsize, objectgsize, objectsubsize, objectstart, data, obj_class, block_size, repeats, keep_data, daosconfig, communicator) bind(c, name="daos_write_object_fortran")
       import :: c_char
       import :: c_int
       import :: c_size_t
       import :: c_double
     ...
     subroutine daos_read_array(num_dims, arraysize, arraygsize, arraysubsize, arraystart, output_data, obj_class, repeats, daosconfig, communicator) bind(c, name="daos_read_array_fortran")
       import :: c_char
       import :: c_int
       import :: c_size_t
       import :: c_double
       ...
       character(kind=c_char), dimension(*), intent(in) :: obj_class
       integer(kind=c_int), value, intent(in) :: num_dims, repeats, daosconfig, communicator
     end subroutine daos_read_array

     subroutine daos_read_object(num_dims, objectsize, objectgsize, objectsubsize, objectstart, output_data, obj_class, repeats, daosconfig, communicator) bind(c, name="daos_read_object_fortran")
       import :: c_char
       import :: c_int
       import :: c_size_t
       import :: c_double
